...
<body>
	...
	<form name="form1">
		<input type="hidden" id="prod_id" name="prod_id"> <input
			...
			type="hidden" id="prod_count" name="prod_c ount"> <input
		...
		<section class="py-5">
			<div class="container px-4 px-lg-5 my-5">
				<div class="row gx-4 gx-lg-5 align-items-center">
					<div class="col-md-6">
						<img id="img_imgsrc" class="card-img-top mb-5 mb-md-0"
							style="width: 400px; height: 400px;"
							src="<c:out value="${product.prod_imgsrc }"/>" alt="..." />
					</div>
					<div class="col-md-6">
						<div class="small mb-1">
							제품 번호: <span id="s_prod_id"><c:out
									value="${product.prod_id }" /></span>
						</div>
						<h1 class="display-5 fw-bolder" id="h_prod_name">
						...
						<div class="fs-5 mb-5">
							<span> <c:forEach begin="1" end="${i.prod_rating/1 }"
									step="1">
									<div class="bi-star-fill"></div>
								</c:forEach> <c:if test="${i.prod_rating % 1 != 0}">
