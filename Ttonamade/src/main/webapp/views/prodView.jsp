    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p class="lead" style="width:300px">재고 수량: <c:out value="${product.prod_count }"/></p>
                <p class="lead">등록일: <c:out value="${product.prod_date }"/></p>
                <div class="d-flex">
                     <input class="form-control text-center me-3" id="inputQuantity" type="number" value="1" style="max-width: 3rem"/>
                    <button class="btn btn-outline-dark flex-shrink-0" type="button" id ="btnSave" value="주문하기"   
					    ...
					    <c:forEach var="i" items="${list }">
							  <tr>
							    <th scope="row"><c:out value="${i.cust_id}"/></th>
							  	 	<td class="fs-5 mb-5">
						                <span>  
							                <c:forEach begin="1" end="${i.prod_rating}" step="1">
