		                    ...
		                    <div class="card-body p-5">
		                        <div class="text-center">
		                            ...
		                            <fmt:formatNumber value="${i.prod_price }" type="currency" />
                             		    ...
                             		    <div class="text-center">  <h6 class="fw-bolder" id ="prod_count" name="prod_count"><c:out value="${i.prod_count }" /></h6></div>
                             ...
                             <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                    	<div class="text-center">		                    
		                         ...
		                         <input type ="button" name ="btnSave" id ="btnSave" value="장바구니담기" 
