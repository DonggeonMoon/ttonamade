		                ...
		                <div class="card h-100">
		                    ...
		                    <div class="card-body p-5">
		                        <div class="text-center">
		                            <!-- Product name-->
		                            <h5 class="fw-bolder"><c:out value="${i.prod_name }" /></h5>
		                            <!-- Product reviews-->
		                            ...
		                            <fmt:formatNumber value="${i.prod_price }" type="currency" />
	                            		    ...
	                            		    <div class="text-center">  <h6 class="fw-bolder" id ="prod_count"><c:out value="${i.prod_count }" /></h6></div>
	                            		    <div class="text-center"><input type="text" id="prod_count-${i.prod_id }" name="prod_count2" style="width:60px; height:30px;"  dir="rtl"  value = <c:out value="${i.prod_count }" /> ></div>
	                            ...
	                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
									<div class="text-center">
										<div class="btn-outline-darkmt-auto"> <input type="button" class="btn btn-outline-warning"
...
<c:if test="${sessionScope.customer != null}"><c:if test="${String.valueOf(sessionScope.customer.cust_manager) == 'M'}">
<div class="text-center mb-5"><a class="btn btn-outline-dark mt-auto mx-3" href="/Ttonamade/insertProd">상품 등록 </a><a class="btn btn-outline-dark mt-auto mx-3" href="/Ttonamade/ProdModifychoice">상품 수정 </a></div>
</c:if></c:if>
	
	
<div class="text-center mb-5"><input type="button" class="btn btn-outline-dark mt-auto text-center" style="text-align:center" value="돌아가기" onclick="history.back(-1)"></div>
