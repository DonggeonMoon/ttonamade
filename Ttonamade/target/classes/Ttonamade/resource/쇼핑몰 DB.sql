...
insert into product_info values(prod_id_seq.nextval, '제품1', 10000, 100, '제품1입니다.', 4.5, sysdate);
...
insert into order_info values('vvvv', 'test', 1000000, '00100', '서울시 강남구', '개포동', '010-0000-0000', 'M', sysdate);
